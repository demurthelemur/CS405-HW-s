...
class MeshDrawer {
  ...
  constructor() {
    ...
    this.ambientLightLoc = gl.getUniformLocation(this.prog, "ambient"); // Location for light color
    this.enableLightingLoc = gl.getUniformLocation(this.prog, "enableLighting");

    this.normalLoc = gl.getAttribLocation(this.prog, "normal"); // Location for vertex normals
